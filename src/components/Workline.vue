...
<script setup>
  const experience = [
    ...
    { 
      ...
      title: 'tibame就業養成班進修', 
      content: [
        '依據 UI/UX 設計 wireframe 與 mockup',
        '設計 user story 與類別圖規劃網站功能',
        '學習 html/css/js/jQuery 網頁切版與功能',
        '資料庫設計，PHP 與 MySQL 資料串接'
      ] 
    },
    { 
      phase: ['台灣知識庫', '前端工程師'], 
      ...
      content: [
        '協作2個 nuxt 約課、購課系統網站',
        '負責1個 nuxt 線上解題網站',
        '多項 html 切版 與 js/jQuery 功能撰寫',
        '自學 flutter 並完成2個 app 畫面切版與功能'
      ] 
    },
    { 
      phase: ['星宇航空', '前端工程師'], 
